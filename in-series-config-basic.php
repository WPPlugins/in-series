...
$meta_links_label = __("Use &lt;link&gt; tags to cross-link articles.", "in_series");
$meta_links_postlabel = __("(enables <a href='http://developer.mozilla.org/en/docs/Link_prefetching_FAQ'>browser prefetching</a>)", "in_series");
...
"
    ...
    {$basic_list_query}
    <p><label><input type='checkbox' name='in_series[meta_links]' {$default_meta_links} />{$meta_links_label}</label> {$meta_links_postlabel}</p>
";
